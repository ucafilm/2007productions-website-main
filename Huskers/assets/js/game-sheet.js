...
class HuskersGameSheet {
        ...
        return `<div class="bg-white rounded-xl shadow-2xl overflow-hidden max-w-7xl mx-auto">
            ...
            <div class="p-6">
                ...
                <div class="mt-8 grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <button id="download-report" class="bg-red-600 text-white p-4 rounded-lg hover:bg-red-700">
                        <i class="fas fa-download mr-2"></i>Download
                    </button>
                    <button id="share-report" class="bg-blue-600 text-white p-4 rounded-lg hover:bg-blue-700">
                        <i class="fas fa-share mr-2"></i>Share
                    </button>
                    <button id="print-report" class="bg-green-600 text-white p-4 rounded-lg hover:bg-green-700">
                        <i class="fas fa-print mr-2"></i>Print
                    </button>
                    <button id="clear-sheet" class="bg-gray-600 text-white p-4 rounded-lg hover:bg-gray-700">
    ...
    updateApiStatus(status) {
        ...
        if (statusElement && statusElement.querySelector('span')) {
            ...
            text.textContent = status?.realData ? '🟢 Live Data' : '🟡 Demo Mode';
        }
    }
...
}ponentSelect?.value || opponentInput?.value || '').trim(),
            date: document.getElementById('game-date')?.value || '',
            season: document.getElementById('season-year')?.value || new Date().getFullYear().toString(),
            location: 'Memorial Stadium, Lincoln, NE',
            tv: 'TBD',
